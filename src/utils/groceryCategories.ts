...
const CLASSIFIERS: { category: GroceryCategory; test: (n: string) => boolean }[] = [
  ...
  },
  {
    ...
    test: matcher([
      ...
      'pangasius', 'koolvis', 'kabeljauw', 'vis', 'dumpling',
    ]),
  },
  {
    ...
    test: matcher([
      ...
      'pizzabloem', 'tarwemeel',
    ]),
  },
  {
    category: 'Noten, zaden & droog',
    test: matcher([
      'noten', 'walnoten', 'amandelen', 'pistache', 'pinda', 'pindakaas',
      'pijnboompitten', 'sesamzaad', 'chiazaad', 'zaad', 'kikkererwt',
      'kidneyboon', 'kidneybonen', 'witte bonen', 'zwarte bonen', 'bonen',
      'kokosvlokken', 'kokosrasp', 'cacao', 'palmsuiker', 'suiker', 'honing',
      'agavesiroop', 'ahornsiroop', 'gist', 'bakpoeder',
    ]),
  },
  {
    ...
    test: matcher(
      [
        ...
        'kwark', 'skyr', 'cottage', 'ricotta', 'feta', 'parmeza', 'mozzarella',
        'fior di latte',
      ],
      ['ei', 'eieren'],
    ),
  ...
  },
  {
    ...
    test: matcher(
      [
        ...
        'spitskool', 'kool', 'wortel', 'doperwten', 'edamame', 'sperziebonen',
        'okra', 'shiitake', 'krieltjes', 'aardappel', 'avocado', 'olijven',
        'sla', 'gemende sla',
      ],
      ['ui', 'uien'],
    ),
  },
  {
    ...
    test: matcher([
      ...
      'rozemarijn', 'oregano', 'dille', 'laurier', 'kaneel', 'komijn', 'kurkuma',
      'piment', 'nootmuskaat', 'saffraan', 'vanille', 'paprikapoeder',
      'chilipoeder', 'chilivlokken', 'chilipeper', 'chili', 'pul biber', 'peper',
      'zout', 'sesamzaad', 'gember', 'kruidenmix', "za'atar", 'zaatar',
    ]),
  },
];
